...
def predictfun(gender, age, fashion_type, country, color):
    ...
    if(os.path.exists(images[0])):
        st.image(images[0], caption='Generated by CoutureBot', use_column_width=True)
    if(os.path.exists(images[1])):
        st.image(images[1], caption='Generated by CoutureBot', use_column_width=True)
    if(os.path.exists(images[2])):
        st.image(images[2], caption='Generated by CoutureBot', use_column_width=True)
